...
export type MemberSessionsQuery = { sessions: Array<{ id: string, sessionName: string, description: string | null, placeName: string, sessionDate: string, startTime: string, endTime: string }> };
