...
export type SessionAttendancesQuery = { sessionAttendances: { items: Array<{ name: string, nickname: string, part: Part, team: string | null, attendanceStatus: AttendanceStatus, updatedAt: string, updatedBy: string, note: string | null }>, pageInfo: { totalPages: number } } };
